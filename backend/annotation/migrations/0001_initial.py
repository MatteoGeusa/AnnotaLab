    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('informed_consent_config', models.JSONField(default=annotation.models.get_default_configuration_for_informed_consent, help_text='Informed Consent Configuration: accept a string can be showed to the annotator before starting the task')),
                ...
                ('screening_config', models.JSONField(blank=True, default=annotation.models.get_default_configuration_for_screening, help_text="Configuration for screening: { 'training_tasks_required': int, 'min_accuracy_required': float }")),
                ('configuration_task_type_file', models.FileField(blank=True, help_text='Optional: Upload a JSON file to overwrite the Task configuration (Labels, Questions).', null=True, upload_to='configs/')),
                ('configuration_screening_file', models.FileField(blank=True, help_text='Optional: Upload a JSON file to overwrite the Screening configuration (Survey, Training).', null=True, upload_to='configs/')),
                ('distribution_strategy', models.CharField(choices=[('STANDARD', 'Standard (Public Pool)'), ('FULL_OVERLAP', 'Everyone sees everything (High Redundancy)'), ('METADATA_MATCH', 'Group Assignment (Metadata Based)')], default='STANDARD', help_text='Defines how documents are assigned to annotators.', max_length=20)),
