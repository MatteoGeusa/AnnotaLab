    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screening_config', models.JSONField(blank=True, default=annotation.models.get_default_configuration_for_screening, help_text="Configuration for quality control: { 'min_accuracy_required': float, 'gold_injection_frequency': int }")),
