    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('configuration_task_type_file', models.FileField(blank=True, help_text='Optional: Upload a JSON file to overwrite the Task configuration (Labels, Questions).', null=True, upload_to='config_uploads/')),
                ('configuration_screening_file', models.FileField(blank=True, help_text='Optional: Upload a JSON file to overwrite the Screening configuration (Survey, Training).', null=True, upload_to='config_uploads/')),
                ...
                ('dataset_file', models.FileField(help_text='Upload a .jsonl file to automatically populate documents.', upload_to='datasets/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
