# Generated by Django 6.0.2 on 2026-02-23 16:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gold_units_file', models.FileField(blank=True, help_text='Upload a .jsonl file for GOLD units (Screening).', null=True, upload_to='datasets/gold/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
