    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata', models.JSONField(blank=True, default=dict)),
                ('is_screening_unit', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screening_config', models.JSONField(blank=True, default=annotation.models.get_default_configuration_for_screening, help_text="Configuration for screening: { 'training_tasks_required': int, 'min_accuracy_required': float, 'gold_injection_frequency': int }")),
                ('distribution_strategy', models.CharField(choices=[('STANDARD', 'Standard (Public Pool) - Randomly assign documents to annotators'), ('FULL_OVERLAP', 'Everyone sees everything (High Redundancy) - All annotators see all documents')], default='STANDARD', help_text='Defines how documents are assigned to annotators.', max_length=20)),
                ...
                ('screening_units_file', models.FileField(blank=True, help_text='Upload a .jsonl file for SCREENING units (Initial phase).', null=True, upload_to='datasets/screening/')),
                ('gold_units_file', models.FileField(blank=True, help_text='Upload a .jsonl file for GOLD units (Injection during regular tasks).', null=True, upload_to='datasets/gold/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Screening Unit',
                'verbose_name_plural': 'Screening Units',
                'proxy': True,
                'indexes': [],
                'constraints': [],
            },
