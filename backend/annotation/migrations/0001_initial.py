# Generated by Django 6.0.2 on 2026-02-22 19:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('distribution_strategy', models.CharField(choices=[('STANDARD', 'Standard (Public Pool) - Randomly assign documents to annotators'), ('FULL_OVERLAP', 'Everyone sees everything (High Redundancy) - All annotators see all documents'), ('METADATA_MATCH', 'Group Assignment (Metadata Based) - Assign documents to annotators based on metadata')], default='STANDARD', help_text='Defines how documents are assigned to annotators.', max_length=20)),
